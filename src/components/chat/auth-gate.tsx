          ...
          {!isForgot && (
            <>
              ...
              <a
                ...
                className="flex h-12 w-full items-center justify-center gap-3 rounded-lg bg-muted/50 text-sm font-medium text-foreground transition-colors hover:bg-muted"
              >
